...
export class default1670772170119 implements MigrationInterface {
    name = 'default1670772170119'

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`CREATE TABLE "categorys" ("id" SERIAL NOT NULL, "description" text NOT NULL, CONSTRAINT "PK_806896a0a29595c702235036597" PRIMARY KEY ("id"))`);
        ...
        await queryRunner.query(`ALTER TABLE "transactions" ADD CONSTRAINT "FK_c9e41213ca42d50132ed7ab2b0f" FOREIGN KEY ("category_id") REFERENCES "categorys"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
    }
