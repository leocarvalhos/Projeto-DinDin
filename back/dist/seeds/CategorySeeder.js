...
var CategorySeeder = /** @class */ (function () {
    function CategorySeeder() {
    }
    CategorySeeder.prototype.run = function (dataSource, factoryManager) {
        return __awaiter(this, void 0, void 0, function () {
            var categoryRepository, descriptionData, newCategory;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        newCategory = categoryRepository.create(descriptionData);
