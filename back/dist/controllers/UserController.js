...
var UserController = /** @class */ (function () {
    ...
    UserController.prototype.cadaster = function (req, res) {
        return __awaiter(this, void 0, void 0, function () {
            var _a, name, email, password, validation, passwordCrypted, e_1;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 3:
                        ...
                        return [4 /*yield*/, userRepository_1.userRepository.insert({
                                name: name,
                                email: email,
        ...
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                try {
                    ...
                    return [2 /*return*/, res.status(500).json(e)];
                }
                return [2 /*return*/];
            });
        });
    ...
    UserController.prototype.updateUser = function (req, res) {
        return __awaiter(this, void 0, void 0, function () {
            var _a, name, email, password, _b, id, currentEmail, user, passwordCrypted, e_3;
            return __generator(this, function (_c) {
                switch (_c.label) {
                    case 0:
                        _a = req.body, name = _a.name, email = _a.email, password = _a.password;
                    ...
                    case 4:
                        ...
                        return [4 /*yield*/, userRepository_1.userRepository.update({ id: id }, { name: name, email: email, password: passwordCrypted })];
                    case 5:
                        _c.sent();
